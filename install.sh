...
show_help() {
    ...
    echo "  $0 --auto --dots --gtk-themes --bluetooth --thunar --xdph --zsh --fish --foot --firefox --pokemon"
    echo ""
    echo "  # Full setup with Fish shell, Foot terminal, and Firefox"
    echo "  $0 --auto --dots --fish --foot --firefox --gtk-themes"
    echo ""
    echo "  # Minimal setup with ZSH and Kitty"
    ...
    echo "  $0 --auto --dots --fish --ghostty --firefox --thunar --xdph --gtk-themes"
    echo ""
    echo "  # Load preset configuration"
    echo "  $0 --preset my-config.sh"
    echo ""
    echo "  # ROG laptop setup"
    echo "  $0 --auto --dots --zsh --kitty --firefox --rog --nvidia --bluetooth --gtk-themes"
    echo ""
    echo "  # Show this help"
    echo "  $0 --help"
}
